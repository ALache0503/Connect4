package de.thbingen.connect4.chat.config;

import de.thbingen.connect4.chat.filter.ChatSubscribeChannelInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureClientInboundChannel(ChannelRegistration reg) {
        reg.interceptors(chatSubscribeChannelInterceptor);
    }
}
