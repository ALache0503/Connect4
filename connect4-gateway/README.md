...
```
cd existing_repo
git remote add origin https://gitlab.rlp.net/movs-4gewinnt/4gewinnt-gateway.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.rlp.net/movs-4gewinnt/4gewinnt-gateway/-/settings/integrations)
