...
```
cd existing_repo
git remote add origin https://gitlab.rlp.net/movs-4gewinnt/connect4-security.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.rlp.net/movs-4gewinnt/connect4-security/-/settings/integrations)
